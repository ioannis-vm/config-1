...
alias home_alone='xrandr --output eDP-1 --mode 1920x1080 --output DP-1-2 --off && nitrogen --restore &'
alias home_portrait='xrandr --output eDP-1 --mode 1920x1080 --output DP-1-2 --mode 2560x1440 --right-of eDP-1 --rotate left && nitrogen --restore &'
...
__conda_setup="$('/home/john_vm/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/john_vm/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/john_vm/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/john_vm/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
